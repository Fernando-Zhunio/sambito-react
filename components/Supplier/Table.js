...
function App() {
            ...
            columns: [
              {
                Header: "RUC",
                accessor: "ruc",
                Cell: e =><a href={'supplier/'+e.value}> {e.value} </a>
              },
              {
                Header: "Razon Social",
              ...
              {
                Header: "Nombre PersonaContacto",
                accessor: "nombrePersonaContacto",
              },
              {
                Header: "Telefono PersonaContacto",
                accessor: "TelefonoPersonaContacto",
              },
            ],
          },
        ],
  ...
  const { data, error } = useSWR(url+'/supplier', fetcher);
