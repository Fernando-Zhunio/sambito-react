...
function ClientPage({ client,props}) {
      ...
      <div>
                ...
                <div className={`${styles['card-fz']} card shadow rounded-fz`}>
                    ...
                    <div className="mb-3">
                      ...
                      <input required  value={client.ruc} type="number" className="form-control" id="ruc" name="ruc"  />
                    </div>
                    <div className="mb-3 col-md-6 col-12">
                      <label htmlFor="exampleInputPassword1" className="form-label">Razón Social</label>
                      <input required  value={client.razonSocial} type="text" className="form-control" id="razonSocial" name="razonSocial" />
                    </div>
                    <div className="mb-3 col-md-6 col-12">
                      <label htmlFor="exampleInputEmail1" className="form-label">Nombre Comercial</label>
                      <input required  type="text" value={client.nombreComercial} className="form-control" id="nombreComercial" name='nombreComercial' aria-describedby="emailHelp" />
                    </div>
                      <hr />
                        <h3>USUARIO</h3>
                      ...
                      <div className="mb-3  col-md-6 col-12">
                        ...
                        <input required  type="text" value={client.user} className="form-control" id="user" name="user"/>
                      </div>

                      <div className="mb-3  col-md-6 col-12">
                        <label htmlFor="exampleInputPassword1" className="form-label">Clave</label>
                        <input type="password"  value={client.password } className="form-control" id="password" name="password"/>
                      </div> 
                      <hr />
                        <h3>SEGMENTOS</h3>
                      <div className="mb-3  col-md-6 col-12">
...
export async function getServerSideProps(context)  {
  ...
  const { data: client } = await axios.get(
    url+"Client/get/" + context.query.id
  );
