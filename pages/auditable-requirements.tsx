    ...
    const requirementsAll = [
        {
            ...
            requirements: [
                ...
                { id: 2, description: "Proveedor cargará el Nombramiento del Representante Legal y el registro en el Registro Mercantil, se verificará la vigencia del mismo en la Superintendencia de Compañías." },
                { id: 3, description: "Proveedor cargará la copia simple de cédula de identificación, y copia simple del certificado de votación vigente, debe ser claramente legible todos los datos." },
                { id: 4, description: "Proveedor cargará los comprobantes de Impuestos Prediales vigentes de la oficina matriz de la empresa en caso que sea propia; de ser alquilada, cargará el Contrato de Arrendamiento registrado en la entidad competente." },
                { id: 5, description: "Proveedor cargará la planilla de servicio básico (Electricidad, Agua, Teléfono, Internet) a nombre de la Empresa para confirmar domicilio del proveedor." },
                { id: 6, description: "Proveedor cargará el Permiso emitido por el Cuerpo de Bomberos, se verificará la vigencia, razón social y dirección del documento." },
                { id: 7, description: "Proveedor cargará el Permiso de Funcionamiento emitido por la Municipalidad, se validará vigencia, razón social y dirección del documento." },
                { id: 8, description: "Proveedor cargará Certificado de Licitud de Fondos, vigente." },
                { id: 9, description: "Proveedor cargará Certificado que los Accionistas No son Personas Expuestas Políticamente, o relacionadas con un PEP a tercer grado de consanguinidad. Formato descargable" },
                { id: 10, description: "Proveedor cargará la Constitución, Reformas, Aumentos de Capital, Cambios de Dirección, y otros actos jurídicos, se verificará si los mismos se encuentran registrados en la Superintendencia de Compañías." },
                { id: 11, description: "Proveedor cargará la Nómina de Accionistas descargada de la Superintendencia de compañías." },
                { id: 12, description: "Proveedor cargará el Certificado de Cumplimiento de Obligaciones y Existencia Legal de la Superintendencia de Compañías vigente, se verificará si cumple con sus obligaciones societarias." },
                { id: 13, description: "Proveedor cargará Certificado de Cumplimiento Tributario vigente descargado del SRI, se verificará si cumple con sus obligaciones tributarias." },
                { id: 14, description: "Proveedor cargará los Formularios 101 si es Persona Jurídica o Formularios 102 si es Persona Natural, de los últimos 3 periodos, obtenidos del SRI." },
                { id: 15, description: "Proveedor cargará los Formularios 104 de las 3 últimas declaraciones, obtenidos del SRI." },
                { id: 16, description: "Proveedor cargará el Certificado de Obligaciones Patronales descargado del IESS vigente, y si cumple con sus obligaciones patronales." },
                { id: 17, description: "Proveedor cargará el Reglamento Interno de Trabajo Vigente y la Aprobación por parte del Ministerio de Trabajo." },
                { id: 18, description: "Proveedor cargará el Certificado Bancario vigente, emitido por la institución financiera competente." },
                { id: 19, description: "Proveedor cargará el Informe de Auditoría Externa a los Estados Financieros del último año, se verificará su registro en la Superintendencia de Compañías." },
                { id: 20, description: "Proveedor cargará el Estado de Situación Financiera y el Estado de Resultados con corte al último trimestre, debidamente firmado por Representante Legal y Contador." },
                { id: 21, description: "Proveedor cargará el Certificado de Deuda Actual emitido por un Buró de Crédito." },
                { id: 22, description: "Proveedor ingresará formato establecido donde seleccione si son bienes y/o servicios y el detalle de los 3 más importantes." },
                { id: 23, description: "Proveedor completará la plantilla establecida y cargará 3 Referencias Comerciales actualizadas." },
                { id: 24, description: "Proveedor completará la plantilla establecida de la Declaración Juramentada." },
                { id: 25, description: "Proveedor cargará el Codigo de ética Vigente y la Aprobado." },
                { id: 26, description: "Proveedor cargara información soporte del proyecto de impacto social expuesto en la auditoria.", }]
        },
        {
            ...
            return <div className="accordion-item">
                ...
                <div id={`flush-collapse${index}`} className="accordion-collapse collapse" aria-labelledby={`flush-heading${index}`} data-bs-parent="#accordionFlushExample">
                    <table className="table">
                        ...
                        <tbody>
                            {item.requirements.map((requirement) => <tr >
